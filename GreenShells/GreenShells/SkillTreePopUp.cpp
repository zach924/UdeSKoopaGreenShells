    ...
    m_rowHeight((height - HEADER_HEIGHT) / 8) // 8 tiers
{
    ...
    m_Buttons.emplace(Skills::RangerT1, CreateButton(1, 0, "Ranger", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::RangerT1); }, currentArmyTree.RangerT1 ? ButtonState::Pressed : canResearchArmyTree.RangerT1 ? ButtonState::Unpressed : ButtonState::Disabled));
    ...
    m_Buttons.emplace(Skills::SwordT2, CreateButton(0, 2, "Sword 2", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::SwordT2); }, currentArmyTree.SwordT2 ? ButtonState::Pressed : canResearchArmyTree.SwordT2 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::AxeT1, CreateButton(2, 2, "Axe", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::AxeT1); }, currentArmyTree.AxeT1 ? ButtonState::Pressed : canResearchArmyTree.AxeT1 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::SwordT3, CreateButton(0, 3, "Sword 3", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::SwordT3); }, currentArmyTree.SwordT3 ? ButtonState::Pressed : canResearchArmyTree.SwordT3 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::RangerT2, CreateButton(1, 3, "Ranger 2", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::RangerT2); }, currentArmyTree.RangerT2 ? ButtonState::Pressed : canResearchArmyTree.RangerT2 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::AxeT2, CreateButton(2, 3, "Axe 2", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::AxeT2); }, currentArmyTree.AxeT2 ? ButtonState::Pressed : canResearchArmyTree.AxeT2 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::MaceT1, CreateButton(1, 4, "Mace", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::MaceT1); }, currentArmyTree.MaceT1 ? ButtonState::Pressed : canResearchArmyTree.MaceT1 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::RangerT3, CreateButton(1, 5, "Ranger 3", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::RangerT3); }, currentArmyTree.RangerT3 ? ButtonState::Pressed : canResearchArmyTree.RangerT3 ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::MaceT2, CreateButton(2, 5, "Mace 2", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::MaceT2); }, currentArmyTree.MaceT2 ? ButtonState::Pressed : canResearchArmyTree.MaceT2 ? ButtonState::Unpressed : ButtonState::Disabled));
