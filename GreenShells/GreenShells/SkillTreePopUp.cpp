    ...
    m_rowHeight((height - HEADER_HEIGHT) / 8) // 8 tiers
{
    ...
    m_Buttons.emplace(Skills::Monastery, CreateButton(4,0, "Monastery", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::Monastery); }, currentEmpireTree.Monastery ? ButtonState::Pressed :   canResearchEmpireTree.Monastery ? ButtonState::Unpressed : ButtonState::Disabled));
    m_Buttons.emplace(Skills::Settler, CreateButton(4,1, "Settler", [currentPlayer]() { currentPlayer->UnlockSkill(GameSession::GetInstance().GetWorldState()->GetCurrentTurn(), Skills::Settler); }, currentEmpireTree.Settler ? ButtonState::Pressed : canResearchEmpireTree.Settler ? ButtonState::Unpressed : ButtonState::Disabled));
