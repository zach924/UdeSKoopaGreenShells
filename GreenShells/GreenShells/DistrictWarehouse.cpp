...
DistrictWarehouse::DistrictWarehouse(int owner)
    : District<DistrictWarehouse>(owner, HEALTH, ATTACK_DAMAGE, VIEW_RANGE, NAME, DISTRICT_TYPE, FOOD_COST, WEAPON_YIELD, FOOD_YIELD, SCIENCE_YIELD, NO_UPGRADE, FOOD_BONUS, 0, 0)
{
}
